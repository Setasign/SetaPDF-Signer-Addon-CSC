...
$provider = new GenericProvider([
    ...
    'redirectUri' => rtrim($settings['demoUrl'], '/') . '/async-demo.php',
...
if (!isset($_GET['code'])) {
    ...
    echo '<iframe src="?action=preview" style="width: 90%; height: 90%;"></iframe><br/><br/>'
       . '<div style="text-align: right;"><a href="?action=sign" style="background-color: #4CAF50; border: none; color: white; padding: 15px 32px; text-align: center; text-decoration: none; display: inline-block; font-size: 16px; border-radius: 8px;">Sign</a></div>';
} else {
